...
<body>
    ...
    <script>
                    ...
                    <div class="flex-1 ml-3">
                        ...
                        <div class="mt-1 relative">
                            <div class="flex items-center justify-between w-[100px] h-[21px] bg-[#FFE9B5] bg-opacity-40 rounded-[20px] px-2 z-10">
                                <img src="img/order/minus.png" alt="minus-button" class="cart-minus w-[17px] h-[17px] cursor-pointer" data-id="${item.menu_id}">
                                <span class="text-[13px] text-black font-bold">${item.qty}</span>
                                <img src="img/order/plus.png" alt="plus-button" class="cart-plus w-[17px] h-[17px] cursor-pointer" data-id="${item.menu_id}">
                            </div>
                        </div>
                    </div>
                    <button class="remove-item absolute top-2 right-2 bg-[#FBA304] hover:bg-[#ff9800] text-white w-6 h-6 rounded-full text-base flex items-center justify-center font-bold leading-none p-0" data-id="${item.menu_id}">
        ...
        document.getElementById('checkoutForm').addEventListener('submit', function(e) {
            ...
            document.getElementById('cart_json').value = JSON.stringify(cartArr);
        });
