...
<body>
    <div class="bg-[#FFFADD] w-full h-screen overflow-x-hidden flex fixed top-0 left-0 z-0">
        ...
        <div class="flex-1">
            ...
            <div id="mainCourse"
                ...
                <div class="relative w-[200px] h-[296px] flex justify-center items-center hover-border-2 border-[#FBA304] rounded-xl hover:shadow-[0_0_10px_2px_#FBA304] transition-all duration-300"
                    data-name="Ayam Katsu" data-price="20000" data-img="img/order/ordermenu2.png">
                    {{-- Gambar Menu --}}
                    <img src="img/order/ordermenu2.png" alt="ayam-katsu"
                        class="w-auto h-[250px] object-cover z-0 mt-5">
                    {{-- Teks Add --}}
                    <div class="absolute top-[82%] mt-[6px] text-center">
                        <span class="quantity text-black font-inter font-bold text-[13px]" style="opacity: 0.25;">
                ...
                <!-- Item 3 -->
                <div class="relative w-[200px] h-[296px] flex justify-center items-center hover-border-2 border-[#FBA304] rounded-xl hover:shadow-[0_0_10px_2px_#FBA304] transition-all duration-300"
                    data-name="Ayam Saos Tiram" data-price="20000" data-img="img/order/ordermenu3.png">
                    {{-- Gambar Menu --}}
                    <img src="img/order/ordermenu3.png" alt="ayam-saostiram"
                        class="w-auto h-[250px] object-cover z-0 mt-5">
                    {{-- Teks Add --}}
                    <div class="absolute top-[82%] mt-[6px] text-center">
                        <span class="quantity text-black font-inter font-bold text-[13px]" style="opacity: 0.25;">
                    ...
                    <div class="absolute top-[78%] left-0 w-full text-center transform -translate-y-[50%]">
                        <span class="text-black font-[Poppins] text-[8px] block">
                            Ayam Saos Tiram - Kol Tumis - Puding
                        </span>
                        <div class="flex justify-center items-center mt-[3px] ml-[5px]">
                            <span class="text-black font-semibold font-[Poppins] text-[13px]"
                                style="opacity: 0.82; text-shadow: 0px 4px 8px rgba(0, 0, 0, 0.25);">
                ...
                <!-- Item 4 -->
                <div class="relative w-[200px] h-[296px] flex justify-center items-center hover-border-2 border-[#FBA304] rounded-xl hover:shadow-[0_0_10px_2px_#FBA304] transition-all duration-300"
                    data-name="Lele Goreng" data-price="20000" data-img="img/order/ordermenu4.png">
                    {{-- Gambar Menu --}}
                    <img src="img/order/ordermenu4.png" alt="lele-goreng"
                        class="w-auto h-[250px] object-cover z-0 mt-5">
                    {{-- Teks Add --}}
                    <div class="absolute top-[82%] mt-[6px] text-center">
                        <span class="quantity text-black font-inter font-bold text-[13px]" style="opacity: 0.25;">
                ...
                <!-- Item 5 -->
                <div class="relative w-[200px] h-[296px] flex justify-center items-center hover-border-2 border-[#FBA304] rounded-xl hover:shadow-[0_0_10px_2px_#FBA304] transition-all duration-300"
                    data-name="Telur Dadar" data-price="20000" data-img="img/order/ordermenu5.png">
                    {{-- Gambar Menu --}}
                    <img src="img/order/ordermenu5.png" alt="telur-dadar"
                        class="w-auto h-[250px] object-cover z-0 mt-5">
                    {{-- Teks Add --}}
                    <div class="absolute top-[82%] mt-[6px] text-center">
                        <span class="quantity text-black font-inter font-bold text-[13px]" style="opacity: 0.25;">
                    ...
                    <div class="absolute top-[78%] left-0 w-full text-center transform -translate-y-[50%]">
                        <span class="text-black font-[Poppins] text-[8px] block">
                            Telur Dadar - Kangkung - Tempe - Pisang
                        </span>
                        <div class="flex justify-center items-center mt-[3px] ml-[5px]">
                            <span class="text-black font-semibold font-[Poppins] text-[13px]"
                                style="opacity: 0.82; text-shadow: 0px 4px 8px rgba(0, 0, 0, 0.25);">
                ...
                <!-- Item 6 -->
                <div class="relative w-[200px] h-[296px] flex justify-center items-center hover-border-2 border-[#FBA304] rounded-xl hover:shadow-[0_0_10px_2px_#FBA304] transition-all duration-300"
                    data-name="Telur Puyuh" data-price="20000" data-img="img/order/ordermenu6.png">
                    {{-- Gambar Menu --}}
                    <img src="img/order/ordermenu6.png" alt="telur-puyuh"
                        class="w-auto h-[250px] object-cover z-0 mt-5">
                    {{-- Teks Add --}}
                    <div class="absolute top-[82%] mt-[6px] text-center">
                        <span class="quantity text-black font-inter font-bold text-[13px]" style="opacity: 0.25;">
            ...
            <div id="riceBowl"
                ...
                <!-- Item 1 -->
                <div class="relative w-[200px] h-[296px] flex justify-center items-center hover-border-2 border-[#FBA304] rounded-xl hover:shadow-[0_0_10px_2px_#FBA304] transition-all duration-300"
                    data-name="Ayam Mentega" data-price="20000" data-img="img/order/bowl1.png">
                    {{-- Gambar Menu --}}
                    <img src="img/order/bowl1.png" alt="ayam-mentega"
                        class="w-auto h-[250px] object-cover z-0 mt-5">
                    {{-- Teks Add --}}
                    <div class="absolute top-[82%] mt-[6px] text-center">
                        <span class="quantity text-black font-inter font-bold text-[13px]" style="opacity: 0.25;">
                    ...
                    <div class="absolute top-[78%] left-0 w-full text-center transform -translate-y-[50%]">
                        <span class="text-black font-[Poppins] text-[8px] block">
                            Ayam Saos Mentega - Telur Dadar Rawis
                        </span>
                        <div class="flex justify-center items-center mt-[3px] ml-[5px]">
                            <span class="text-black font-semibold font-[Poppins] text-[13px]"
                                style="opacity: 0.82; text-shadow: 0px 4px 8px rgba(0, 0, 0, 0.25);">
                ...
                <!-- Item 2 -->
                <div class="relative w-[200px] h-[296px] flex justify-center items-center hover-border-2 border-[#FBA304] rounded-xl hover:shadow-[0_0_10px_2px_#FBA304] transition-all duration-300"
                    data-name="Ayam Katsu" data-price="15000" data-img="img/order/bowl3.png">
                    {{-- Gambar Menu --}}
                    <img src="img/order/bowl2.png" alt="ayam-katsu"
                        class="w-auto h-[250px] object-cover z-0 mt-5">
                    {{-- Teks Add --}}
                    <div class="absolute top-[82%] mt-[6px] text-center">
                        <span class="quantity text-black font-inter font-bold text-[13px]" style="opacity: 0.25;">
                ...
                <!-- Item 3 -->
                <div class="relative w-[200px] h-[296px] flex justify-center items-center hover-border-2 border-[#FBA304] rounded-xl hover:shadow-[0_0_10px_2px_#FBA304] transition-all duration-300"
                    data-name="Ayam Asam Manis" data-price="15000" data-img="img/order/bowl3.png">
                    {{-- Gambar Menu --}}
                    <img src="img/order/bowl3.png" alt="ayam-asammanis"
                        class="w-auto h-[250px] object-cover z-0 mt-5">
                    {{-- Teks Add --}}
                    <div class="absolute top-[82%] mt-[6px] text-center">
                        <span class="quantity text-black font-inter font-bold text-[13px]" style="opacity: 0.25;">
        ...
        <div class="w-[439px] min-h-screen bg-white shadow-lg flex flex-col items-center justify-start sticky top-0 right-0 h-screen">
            ...
            <div id="orderSummarySection" class="flex flex-col h-full w-full">
                ...
                <div id="orderList" class="order-summary w-full px-5 flex flex-col gap-3 overflow-y-auto" style="max-height: 520px;"></div>
                <!-- Spacer agar tombol tetap di bawah -->
                <div class="flex-1 mb-6"></div>
                <!-- Total Cart -->
                <div id="cart-total" class="w-full flex justify-between items-center font-bold text-[15px] pt-3 border-t mt-2 mb-4 px-6">
                    <span>Total Price:</span>
                    <span id="cart-amount" class="text-[#22668D]">Rp.0</span>
                </div>
                <!-- Tombol GO TO ORDER selalu di bawah -->
                <div id="goToOrderBtn" class="w-full flex flex-col items-center mb-8 relative cursor-pointer pointer-events-none opacity-50">
        ...
        <div id="formSection" class="hidden w-full min-h-screen flex flex-col bg-white px-8 pt-6 shadow-lg">
            ...
            <div class="flex items-center justify-between mt-4 mb-2 px-2 ">
                ...
                <h3 class="font-bold font-poppins text-[16px] text-black text-center flex-1 absolute left-0 right-0 mx-auto" style="pointer-events:none;">Deliver to</h3>
            ...
            <div class="relative flex items-center justify-center my-2">
                ...
                <h3 class="font-bold font-poppins text-[16px] text-black mt-5 mb-4 text-center">Customer Information</h3>
                <div class="flex flex-col gap-4 mb-4">
                    <input type="text" placeholder="Name" class="border px-4 py-2 rounded-full outline-none shadow-sm" />
                    ...
                    <input type="text" placeholder="Note.." class="border px-4 py-2 rounded-full outline-none shadow-sm" />
                </div>
                <div class="mt-auto mb-8 w-full flex justify-center">
                    <button id="confirmOrderBtn" class="bg-gradient-to-b from-[#0C4A6E] to-[#0A3D59] text-white font-bold px-8 py-2 rounded-full">
                        CONFIRM
                    </button>
                </div>
            </div>
            ...
            <div id="orderDetailsSection" class="hidden w-full min-h-screen flex flex-col bg-white px-8 pt-6 shadow-lg">
                <div class="flex items-center justify-between mt-4 mb-2 px-2">
                    <a href="javascript:void(0);" id="backToFormBtn" class="flex items-center">
                        <img src="img/order/backbutton.png" alt="back-button" class="w-[30px] h-[30px]" />
                    </a>
                    <h3 class="font-bold font-poppins text-[16px] text-black text-center flex-1 absolute left-0 right-0 mx-auto" style="pointer-events:none;">Order Summary</h3>
                    <div style="width:32px;"></div>
                </div>
                <div class="relative flex items-center justify-center my-2">
                    <div class="absolute h-[1.6px] w-[260px] bg-[#000000] z-0"></div>
                ...
                <div class="mt-auto mb-8 w-full flex justify-center">
                    <button class="bg-gradient-to-b from-[#0C4A6E] to-[#0A3D59] text-white font-bold px-8 py-2 rounded-full ">
                        Proceed to Payment
                    </button>
                </div>
            </div>
            ...
            <div id="paymentSection" class="hidden w-full min-h-screen flex flex-col bg-white px-8 pt-6 shadow-lg">
                ...
                <div class="flex items-center justify-between mt-4 mb-2 px-2">
                    ...
                    <h3 class="font-bold font-poppins text-[16px] text-black text-center flex-1 absolute left-0 right-0 mx-auto" style="pointer-events:none;">Payment</h3>
                    <div style="width:32px;"></div>
                </div>
                <div class="relative flex items-center justify-center my-2">
                    <div class="absolute h-[1.6px] w-[260px] bg-[#000000] z-0"></div>
                ...
                <div class="mt-6 mb-6 border-2 border-[#DDD9D9] rounded-[20px] p-4 shadow-md">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center mb-2">
                            <input type="radio" id="transferMethod" name="paymentMethod" value="transfer" checked class="mr-2">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center mb-2">
                            <input type="radio" id="codMethod" name="paymentMethod" value="cod" class="mr-2">
                ...
                <div class="mb-4" id="uploadProofWrapper">
                    <label class="font-bold mb-2 block">Upload Your Payment Proof <span class="text-red-500">*</span></label>
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                        ...
                        <button type="button" onclick="document.getElementById('paymentProof').click()" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-full text-sm font-medium">
                            Upload a File
                        </button>
                    </div>
                ...
                <div class="mt-auto mb-8 w-full flex justify-center">
                    <button id="completeOrderBtn" class="bg-gradient-to-b from-[#0C4A6E] to-[#0A3D59] text-white font-bold px-8 py-2 rounded-full">
                        COMPLETE ORDER
                    </button>
                </div>
            </div>
            <!-- Success Popup -->
            <div id="successPopup" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
                <div class="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
                    ...
                    <button id="closeSuccessPopup" class="bg-[#0C4A6E] text-white px-6 py-2 rounded-full font-bold">OK</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function showMainCourse() {
            ...
            // Geser slider ke kiri (Main Course)
        ...
        function showRiceBowl() {
            ...
            // Geser slider ke kanan (RiceBowl)
      ...
      // Render order details
        ...
        document.getElementById('completeOrderBtn').addEventListener('click', function () {
            ...
            if (paymentMethod === 'transfer' && !paymentProof.files[0]) {
                ...
                paymentProof.scrollIntoView({ behavior: 'smooth', block: 'center' });
                return;
            }
