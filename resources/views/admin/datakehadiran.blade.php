...
<body class="bg-[#FFFADD]">
    ...
    <div class="bg-white rounded-xl shadow-xl px-8 py-4 flex items-center justify-center mb-6">
        ...
        <button
            ...
            onclick="openEditModal(this)" data-id="SIS-1" data-fullname="Zahirah Salsabila" data-attendance="Present">
            Edit Attendance
        </button>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-xl px-6 py-4 relative z">
        ...
        <div class="flex justify-between items-start mt-8 w-full">
            ...
            <div class="flex gap-3 w-[452px]">
                <button
                    class="flex items-center justify-center cursor-pointer bg-[#2CAA6B] hover:bg-[#23995f] text-white text-sm font-medium py-2 px-4 rounded-[20px] w-[220px]">
                    <img src="/img/admin/datakehadiran/excell.png" alt="Excel" class="w-auto h-auto mr-2" />
                    Export to Excel
                </button>
                <button
                    class="flex items-center justify-center cursor-pointer bg-[#A3A3A3] hover:bg-[#8c8c8c] text-white text-sm font-medium py-2 px-4 rounded-[20px] w-[220px]">
    ...
    <div id="editAttendanceModal"
        class="fixed inset-0 bg-black bg-opacity-40 hidden items-center justify-center z-50 font-[Poppins]">
        <div class="bg-white w-[700px] rounded-2xl shadow-lg px-8 py-8 relative">
            <!-- Tombol Close -->
            <button onclick="closeEditModal()"
                class="absolute top-3 right-4 text-2xl text-[#FFB100] font-bold">✕</button>
                    ...
                    <tbody>
                        <tr class="bg-[#FFE39C]">
                            ...
                            <td class="px-4 py-2 border border-[#FBA304]">
                                <label class="mr-4">
                                    <input type="radio" name="attendance1" id="modal-present"
                                        class="accent-green-500" /> Present
                                </label>
                                <label>
                                    <input type="radio" name="attendance1" id="modal-excused"
                                        class="accent-yellow-500" /> Excused
                                </label>
                            </td>
                        </tr>
                        <tr class="bg-[#FFFADD]">
            ...
            <div class="mt-6 text-right">
                <button class="bg-sky-900 text-white px-5 py-2 rounded-md font-semibold hover:bg-sky-800"
                    onclick="closeEditModal()" type="button">
                    Save Attendance
                </button>
            </div>
        </div>
