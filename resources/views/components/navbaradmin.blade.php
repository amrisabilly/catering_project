<div x-data="{ sidebarOpen: true }" class="absolute flex font-sans bg-transparent">
    ...
    <div class="w-[350px] h-screen bg-[#002E48] flex-shrink-0 flex flex-col py-10 px-8 transition-transform duration-300 z-20 fixed md:static"
        ...
        <nav class="flex flex-col gap-6 ">
            <a href="/admin/dashboard"
                class="flex items-center text-white text-base  hover:text-[#FFCC70] transition font-poppins font-medium mt-10">
            ...
            <a href="/admin/datasiswa"
                class="flex items-center text-white text-base hover:text-[#FFCC70] transition font-poppins font-medium">
                <img src="/img/admin/dashboard/laporan.png" alt="Data Siswa" class="w-[30px] h-[30px] ml-6" />
                <span class="ml-4">Laporan Data Siswa</span>
            </a>

            <a href="/admin/datapesanan"
                class="flex items-center text-white text-base hover:text-[#FFCC70] transition font-poppins font-medium">
            ...
            <a href="/admin/daftarmenu"
                class="flex items-center text-white text-base hover:text-[#FFCC70] transition font-poppins font-medium">
                <img src="/img/admin/dashboard/menu.png" alt="Menu" class="w-[30px] h-[30px] ml-6" />
                <span class="ml-4">Daftar Menu</span>
            </a>

            <div class="flex items-center text-white text-opacity-[50%] font-poppins font-medium  ml-2 mb-4"
                style="opacity: 0.6">
    ...
    <button
        ...
        :class="sidebarOpen ? 'translate-x-[350px]' : 'translate-x-0'" @click="sidebarOpen = !sidebarOpen"
        aria-label="Toggle Sidebar" style="will-change: transform;">
        <img src="/img/admin/dashboard/option.png" class="w-auto h-auto" alt="menu" />
    </button>

    <!-- Overlay for mobile -->
    <div class="fixed inset-0 bg-black bg-opacity-40 z-10 transition-opacity duration-300 md:hidden"
