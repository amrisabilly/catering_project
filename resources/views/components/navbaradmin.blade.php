<div x-data="{ sidebarOpen: false }" class="absolute flex font-sans bg-transparent">
    <!-- Sidebar -->
    <div 
    ...
    >
        <nav class="flex flex-col gap-6 ">
            ...
            <a href="/admin/daftarmenu" class="flex items-center text-white text-base hover:text-[#FFCC70] transition font-poppins font-medium">
            ...
            <a href="/admin/login" class="flex items-center text-white text-base hover:text-[#FFCC70] transition font-poppins font-medium">
